...
// Fresh classification with FIXED enum mapping (sentiment=0 = BAD_NEWS)
const classificationId = '0xb98b31be6d9dfca1069eecc14159b73b121138ce6c552e5f8d8f3fd31bdb7446';

console.log('🐻 E2E Test: Executing BEARISH trade with FIXED sentiment enum...\\n');
...
try {
  ...
  if (ethChange > 0 && usdcChange > 0) {
    ...
    console.log('✨ Trade should now appear in the UI at http://localhost:3001');
  } else {
